...
// Route::patch('/admin/edit/{id}', 'AdminController@editIndex');
Route::post('/admin/edit/{id}', 'AdminController@edit');
// Route::patch('/admin/edit/{id}', 'AdminController@edit');
...
// Route::patch('/admin/edit/{id}', [AdminController::class, 'edit'])->name('admin.edit');
